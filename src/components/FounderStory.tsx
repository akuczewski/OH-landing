    ...
    return (
        <section className="relative py-28 px-6 bg-light-cream">
            ...
            <div className="max-w-6xl mx-auto lg:pl-16">
                <div className="grid lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1.3fr)] gap-14 lg:gap-20 items-center">
                    <Reveal>
                        <div className="relative w-full max-w-sm aspect-[4/5] mx-auto lg:mx-0">
